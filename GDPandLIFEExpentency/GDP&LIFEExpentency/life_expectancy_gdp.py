...
"Chile, China, USA, Germany, Mexico, Zimbabwe"
...
plt.ylabel("GDP")
plt.savefig("GDP per Country.png")
plt.show()
...
plt.ylabel("LEABY") 
plt.savefig("LEABY per Country.png")
plt.show()
...
"There doesnt seem to be coorelation between GDP and LEABY as they doesnt look similar"
...
plt.savefig("LEABY per Country_violin.png")
plt.show()
...
"The LEABY distribution is small to all countries except for Zimbabwe,where it changed the most"
...
plt.title(("GDP per Country&Year"))
plt.savefig("GDP per Country-Year.png")
plt.show()
...
sns.set_palette("dark")
plt.title(("LEABY per Country&Year"))
plt.savefig("LEABY per Country-Year.png")
plt.show()
...
"Which countries' bars changes the most? - (For GDP, its USA and China. For LEABY, its Zimbabwe)"
"What years are there the biggest changes in the data? (2000 - 2015)"
"Which country has had the least change in GDP over time? - (Mexico& Chile)"
"How do countries compare to one another? - (It includes developing countries, developed countries, & underdeveloped countries)"
"Now that you can see the both bar charts, what do you think about the relationship between GDP and life expectancy? - (There doesnt seem to be correlated)"
"Can you think of any reasons that the data looks like this for particular countries? - (The reason for China's exponentional grouth is the economic reforms during the last Qtr of the 2th Century)"
...
g = sns.FacetGrid(df, col="Year", hue="Country", col_wrap=4, height=2, palette="Set2")
g = (g.map(plt.scatter, "GDP", "LEABY", edgecolor="w").add_legend())
plt.savefig("GDP per Country-Year(FacetGrid_scatter).png")
...
"Which country moves the most along the X axis over the years? - (Zimbabwe)"
"Which country moves the most along the Y axis over the years? - (China)"
"Is this surprising? - (Nope)"
"Do you think these scatter plots are easy to read? Maybe there's a way to plot that! - (Yes)"
...
plt.savefig("LEABY per Country-Year(FacetGrid_Line).png")
...
"What years are there the biggest changes in the data? - (2005 - 2015)"
"Which country has had the least change in life expectancy over time? - (USA)""
"Can you think of any reasons that the data looks like this for particular countries? - (The LEABY in Zambabwe has significantly decreased from 1990 to 2005 due to several factors like bad economy, HIV, AIDS and other deadly diseases)"
...
plt.savefig("GDP per Country-Year(FacetGrid_line).png")
...
"Due to economic reforms by opening markets to external investments and updating labor laws in the last qrt of 2th century"
